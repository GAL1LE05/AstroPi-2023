...
def contrast_stretch(im):
    """
    This function takes in an image (array of pixels) as argument and, taking into account the min and max values of the pixels, it stretches the contrast of the image as to make small changes more evident.
...
def calc_ndvi(image):
    """
    This function takes an image (array of pixels) as argument.
